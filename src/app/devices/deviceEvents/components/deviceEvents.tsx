 ...
 **********************************************************/
 ...
 export const DeviceEvents: React.FC = () => {
     ...
     const labelData = {
         labels: [] as any, // tslint:disable-line:no-any
         datasets: [ // tslint:disable-line:object-literal-sort-keys
           {
             label: 'Verified',
             fill: false, // tslint:disable-line:object-literal-sort-keys
             lineTension: 0.5,
             height: 200,
             width: 400,
             ...
             borderColor: 'black',
             borderWidth: 2,
             data: [] as any, // tslint:disable-line
             pointRadius: 7,
             pointBackgroundColor: [] as any, // tslint:disable-line:no-any
           },
           {
               label: 'Unverified',
               backgroundColor: 'darkorange', // tslint:disable-line:object-literal-sort-keys
           }
         ]
       };
     ...
     const isVtString = () => {
         if (componentName) {
         return (componentName.substring(0, 2) === 'vT'); // tslint:disable-line:no-magic-numbers
         }
     ...
     const renderRawEvents = () => {
         ...
         if (componentName && isVtString() && componentName !== 'vTDevice') {
             return events;
         }
     ...
     const getTime = (timeStamp: string) => {
         return timeStamp.substring(16, 24); // tslint:disable-line:no-magic-numbers
     };
     ...
     if (componentName !== '' && isVtString() && componentName !== 'vTDevice') {
        // tslint:disable-next-line:no-any
         ...
         labelData.datasets[0].data = measurements;
         labelData.datasets[0].pointBackgroundColor = pointBackgroundColors;
         return (
            ...
            <Line
                data={labelData}
                options={{
                maintainAspectRatio: false, // tslint:disable-line:object-literal-sort-keys
                legend: { // tslint:disable-line:object-literal-sort-keys
                    display: true,
                    position: 'right'
                }
                }}
